...
async function main() {
    ...
    const stuff = { glStuff, camera, world, atlas, input: inputInfo };
...
const SHADER_ATTRIBUTE_NAMES = ['a_Position', 'a_UV'];
const SHADER_UNIFORM_NAMES = ['u_CameraMat', 'u_BlockPos', 'u_TextureAtlas', 'u_MaxTextureAtlasLOD', 'u_TextureAtlasDimensions', 'u_Color'];
