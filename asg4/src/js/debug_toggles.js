...
export const DEBUG_TOGGLES = ['disable_lighting', 'show_normals', 'show_uvs', 'no_backface_culling', 'no_draw_chunks', 'colorize_mipmaps', 'render_wireframe', 'fast_movement', 'draw_atlas_packing_internal_state', 'force_webgl_1_only', 'force_no_gl_extensions'];
