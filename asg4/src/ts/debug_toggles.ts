...
export const DEBUG_TOGGLES = ['show_normals', 'no_backface_culling', 'no_draw_chunks', 'colorize_mipmaps', 'render_wireframe', 'fast_movement', 'draw_atlas_packing_internal_state', 'force_webgl_1_only', 'force_no_gl_extensions'] as const;
